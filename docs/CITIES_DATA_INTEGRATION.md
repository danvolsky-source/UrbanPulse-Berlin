...
3. **New York** - Financial capital, 8.3M population
4. **Los Angeles** - Entertainment capital, 4.0M population
5. **Chicago** - Midwest hub, 2.7M population
6. **Washington D.C.** - Federal capital, 0.7M population

### 🇫🇷 France (1 city)

7. **Paris** - Capital, 2.2M population

### 🇬🇧 United Kingdom (1 city)

8. **London** - Financial center, 9.0M population

### 🇨🇦 Canada (1 city)

9. **Toronto** - Ontario capital, 2.9M population

### 🇦🇹 Austria (1 city)

10. **Vienna (Wien)** - Capital, 1.9M population

### 🇮🇹 Italy (1 city)

11. **Rome (Roma)** - Capital, 2.9M population

### 🇳🇱 Netherlands (1 city)

12. **Amsterdam** - Capital, 0.9M population

### 🇧🇪 Belgium (1 city)

13. **Brussels (Bruxelles)** - EU capital, 1.2M population

### 🇪🇸 Spain (1 city)

14. **Madrid** - Capital, 3.3M population

### 🇵🇱 Poland (1 city)

15. **Warsaw (Warszawa)** - Capital, 1.8M population
...
CREATE TABLE cities (
  ...
  country_code CHAR(2) NOT NULL, -- DE, US, FR, GB, CA, AT, IT, NL, BE, ES, PL
  population INTEGER,
...
```sql
INSERT INTO cities (name, country, country_code, population, latitude, longitude)
VALUES
  ...
  ('Madrid', 'Spain', 'ES', 3300000, 40.416775, -3.703790),
  ('Warsaw', 'Poland', 'PL', 1800000, 52.229676, 21.012229);
```
...
- **Idealista**: Property prices

### 🇵🇱 Poland

**Primary Sources:**
- **GUS** (Central Statistical Office): https://stat.gov.pl/
- **Warsaw Open Data**: https://api.um.warszawa.pl/
- **NBP**: Economic indicators
...
export const DATA_SOURCES = {
  ...
  ES: {
    demographics: 'https://www.ine.es/dyngs/DataLab/en/index.htm',
    housing: 'https://www.idealista.com/labs/',
    openData: 'https://datos.madrid.es/egob/'
  },
  PL: {
    demographics: 'https://api.stat.gov.pl/',
    openData: 'https://api.um.warszawa.pl/',
    housing: 'https://nbp.pl/en/statistic-and-financial-reporting/'
  }
};
```
