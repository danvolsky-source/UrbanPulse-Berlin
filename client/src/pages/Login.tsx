...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4">
      <Card className="w-full max-w-md p-8 bg-slate-900/50 border-slate-800">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Welcome to UrbanPulse</h1>
          <p className="text-slate-400">
            Track government decisions and their impact on property markets
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* Manus Sign In */}
          <Button
            onClick={() => window.location.href = manusLoginUrl}
